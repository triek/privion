    ...
    <div ref="bookMenuRef" class="fixed bottom-6 right-6 z-40 flex flex-col items-end gap-4">
      ...
      >
        ...
        >
          ...
          <svg
            v-else-if="option.icon === 'ingredient'"
            xmlns="http://www.w3.org/2000/svg"
            class="h-4 w-4"
            fill="none"
            viewBox="0 0 24 24"
          ...
          >
            ...
            <path stroke-linecap="round" stroke-linejoin="round" d="M7 8.5v7" />
            <path stroke-linecap="round" stroke-linejoin="round" d="M17 8.5v7" />
          </svg>
        </RouterLink>
      </div>
...
type CollectionMenuItem = NavItem & { icon: 'recipe' | 'ingredient' | 'workout' }
