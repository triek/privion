      ...
      <div class="mx-auto flex max-w-6xl flex-col gap-4 px-6 py-6 sm:flex-row sm:items-center sm:justify-between">
        ...
        >
          ...
          <!-- <div ref="bookMenuRef" class="relative">
            ...
            >
              <span class="sr-only">Open collections</span>
            ...
            <div
              v-if="isBookMenuOpen"
              class="absolute right-0 z-50 mt-2 w-48 rounded-xl border border-white/10 bg-slate-900/95 p-2 text-sm text-slate-200 shadow-xl"
              role="menu"
            >
              <RouterLink
                ...
                :key="option.to"
                :to="option.to"
                class="flex items-center justify-between gap-3 rounded-lg px-3 py-2 transition hover:bg-white/10 hover:text-white"
                role="menuitem"
                @click="handleBookMenuSelection"
              >
                <span>{{ option.label }}</span>
                <svg v-if="option.icon === 'recipe'" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                ...
                <svg v-else xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M6 3.75h9a2.25 2.25 0 0 1 2.25 2.25v12a2.25 2.25 0 0 1-2.25 2.25H6A2.25 2.25 0 0 1 3.75 18V6A2.25 2.25 0 0 1 6 3.75Z" />
